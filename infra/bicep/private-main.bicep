...
module azmlModule 'private-azml.bicep' = {
  name: 'AzMLDeploy'
  scope: resourceGroup()
  params: {
    location: location
...
output foundryAccountName string = foundryModule.outputs.foundryName
output azureMLName string = azmlModule.outputs.outAzureMLName
...
output modelDeploymentUri string = foundryModule.outputs.modelDeploymentUri
output modelDeploymentKey string = foundryModule.outputs.modelDeploymentKey
output modelDeploymentModelApiVersion string = foundryModule.outputs.modelDeploymentModelApiVersion
output modelDeploymentModelName string = foundryModule.outputs.modelDeploymentModelName