...
module azmlModule 'public-azml.bicep' = {
  name: 'AzMLDeploy'
  scope: resourceGroup()
  params: {
    location: location
...
output outFoundryAccountName string = foundryModule.outputs.foundryName
output outAzureMLName string = azmlModule.outputs.outAzureMLName
output outAcrName string = containerRegistryModule.outputs.outAcrName 
output outAppInsightsName string = appInsightsModule.outputs.outAppInsightsName
output outStorageAccountName string = storageModule.outputs.outStorageAccountName
output outModelDeploymentName string = foundryModule.outputs.outModelDeploymentName
output outModelDeploymentUri string = foundryModule.outputs.outModelDeploymentUri
output outModelDeploymentKey string = foundryModule.outputs.outModelDeploymentKey
output outModelDeploymentModelApiVersion string = foundryModule.outputs.outModelDeploymentModelApiVersion
output outModelDeploymentModelName string = foundryModule.outputs.outModelDeploymentModelName